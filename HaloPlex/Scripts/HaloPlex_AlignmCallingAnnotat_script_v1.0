...
#        fastqc ${k}_L001_R1_001.trimmed.fastq.gz
#	fastqc ${k}_L001_R2_001.trimmed.fastq.gz
#Decompress
...
####
java -Xmx250g -jar ${PICARD} AddOrReplaceReadGroups INPUT=${k}.sorted.bam  \
CREATE_INDEX=true \
ID=${k} \
LB=${k} \
SM=${k} \
...
#vim -c "%s/_SNVs.myanno.hg38_multianno.txt//g|wq" LibraryHALO_SNVs_hg38_multianno.txt
